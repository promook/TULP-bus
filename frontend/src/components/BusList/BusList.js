      ...
      return (
        <div key={idx} className="card mt-5 buslist">
          <div class="row ml-3">
            ...
            <div class="col-6 col-sm-3 mt-2 font-weight-bold ">จาก</div>
            <div class="col-6 col-sm-3 mt-2 font-weight-bold ">ถึง</div>
            <div class="col-6 col-sm-3 mt-2 font-weight-bold ">ราคา</div>
